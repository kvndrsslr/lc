...
To this end, our system requires one central trusted authority, the voting registry (VR).
...
The VR contributes to the verifiability of the process by blind signing vote authorization keys.
Note that by using a blind signature scheme secrecy is preserved while being able to prove that (a) a given vote has been counted and (b) the vote was actually issued by someone who owns the right to vote.
...
% The casted votes can now be counted by any actor as follows:
% \begin{enumerate}
