...
These discussions contents and their metadata are only meaningful when put in relation to the corresponding propositions.
Therefore, they should be accessible as dependent information over the same interfaces which also exhibit the propositions data itself.
