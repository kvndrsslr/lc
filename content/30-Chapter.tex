\chapter[A CS Approach to LD]{A Citizen Science Approach to Liquid Democracy Processes}
\label{ch:Approach}
...
One could either have a distinct delegation graph for every proposition, for every context, or have one delegation graph with an edge for every delegation (i.e., a labeled multigraph). \todo[inline]{This is more implementation than model and should probably be descruibed in ch.\ref{ch:Our_Project}}
...
While this can't be implemented to its fullest within the scope of this project, this aspect needs considerable consideration in the development of the platform (i.e., in ch. \ref{ch:Our_Project}).
