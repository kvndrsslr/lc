...
The chapter is then concluded by the specification of two protocols, namely the \hyperref[sec:PublicInteractionProtocol]{public interaction protocol} and the \hyperref[sec:VoteTallyingProtocol]{vote tallying protocol}, that revolve around vote and delegation intents posted in the public space.
...
%Then, we define two protocols, namely the \hyperref[sec:PublicInteractionProtocoll]{public interaction protocol} and the \hyperref[sec:VoteTallyingProtocol]{vote tallying protocol}, that revolve around vote and delegation intents in the public space.
...
The public interaction protocol describes the steps necessary to post a vote or delegation intent to a public space.
