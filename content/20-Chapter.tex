...
A proxy in liquid democracy has the same two choices as the principal(s) the vote was coming from. [TO BE CONTINUED HERE] 

Taking the perspective of a proxy you can recursivly have to options again. vote directly yet with more power (see yellow) or in case to delegate---Being a proxy you get defacto a principal in LD---in case of uncertainty or in the. Finally, you delegation will ultimately hit its last vertex (blue) who has an opinion and will finally vote.
