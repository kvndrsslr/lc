...
An approach inspired by very recent progress in the field of machine learning~\parencite{Boesche2013} would be to completely decouple the internal platform data from the data observable by citizen scientists by using pattern-coherent data synthesis.
