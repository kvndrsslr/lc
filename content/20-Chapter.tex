...
After introducing the basic terms and the context they stem from (in \ref{ssec:Background_CS} and \ref{ssec:LD-Foundations} respectively), issues and open questions are addressed for both concepts separately (in \ref{ssec:Issues_CS} and \ref{ssec:Issues_LD} respectively). 
...
Even though are many forms of political government, it is democracy that spread around the globe over the last hundred years (see \autoref{fig:democracy-trend}). \textit{“As of the end of 2016, 97 out of 167 countries (58\,\%) [\ldots] were democracies [\ldots]”} \parencite{Desilver2017}. According to the observations in \autoref{fig:democracy-trend} it can be argued that democracy is a successful and thus modern structure, since there are no competing political system showing a similar thriving trend as democracy does.
...
% 	% upto here↑
    ...
    \draw (0.800,1.03) node {\textsf{\textbf{Voting results}}};
	...
	\end{scope}
	\end{tikzpicture}
    \caption[Illustration of liquid democracy]{Illustration of liquid democracy. }
