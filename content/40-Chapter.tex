...
The core of this section will be an \href{sec:Evaluation}{evaluation} of existing approaches, based on the criteria derived in \ref{sec:Criteria}. These will be discussed in \autoref{sec:DiscussionRW}, and we will evaluate which platforms serve as a basis for the prototype this project strives to develop.
...
Basically say why its all rubbish and we need to do it ourselves, leading into the \href{sec:ProjectRequirements}{requirements}.