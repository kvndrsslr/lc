...
Based on the \hyperref[ch:Approach]{discussion of the approach} to fulfill the objective of this project, and due to the fact that no suitable software exists to base the project on, this section will document the initial software engineering process upon which can be built in order to realize a platform that meets the derived \hyperref[sec:Criteria]{criteria} for a Citizen Science-focused Liquid Democracy Platform.\\
