\usepackage[style=authoryear,dashed=true,uniquelist=false,maxbibnames=10,maxcitenames=2,autocite=inline,block=space,backref=true,backrefstyle=three+,date=short]{biblatex}
