...
\usepackage{float}			% enables H for tables: \begin{table}[H]
...
\usepackage[colorinlistoftodos,prependcaption,bordercolor=yellow!75,backgroundcolor=yellow!40,linecolor=yellow!75,textsize=tiny,textwidth=1.95cm]{todonotes}
